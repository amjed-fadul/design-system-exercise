# Projects Directory Blind Evaluation — Run 003

This branch is an isolated Task 5 evaluation branch.
...
- current branch is `ai-eval/projects-directory-run-003`;
...
6. Work only inside:
   `apps/storybook/src/ai-readiness/evaluations/projects-directory/`

You may reread/edit files created inside this directory during the run.

Do not ask for human corrections. If approved authority does not resolve a decision, record it as unresolved in `AUTHORING-REPORT.md` instead of guessing.
