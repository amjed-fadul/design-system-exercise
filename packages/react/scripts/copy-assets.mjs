...
const topNavbarCss = await readFile(
  new URL('../src/top-navbar/TopNavbar.css', import.meta.url),
  'utf8',
);
const pageHeadingCss = await readFile(
...
const tableCss = await readFile(new URL('../src/table/Table.css', import.meta.url), 'utf8');
