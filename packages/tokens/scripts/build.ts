...
import { generateDocumentationTypeScript } from './lib/documentation.js';
...
writeFileSync(
  ...
  [
    ...
    generateDocumentationTypeScript(registry),
  ].join('\n'),
);
writeFileSync(
  new URL('../.generated/tokens.css', import.meta.url),
...
console.log(
  `Generated ${registry.staticTokens.size + registry.modeTokens.size} logical tokens`,
);
